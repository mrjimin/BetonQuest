 ...
 */
public class TanSubRoutine extends AbstractSubRoutine {

    /**
     * Creates a new TanSubRoutine.
     */
    public TanSubRoutine() {
        super(false, param("x"));
    }
    ...
    public FunctionAssignment evaluateSubroutine(final FunctionProvider functionProvider, final Map<String, FunctionAssignment> arguments) {
        ...
        return new NumberSourceAssignment(Math.tan(number.doubleValue()));
    }
}
