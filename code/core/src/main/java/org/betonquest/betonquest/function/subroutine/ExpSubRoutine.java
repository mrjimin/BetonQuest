 ...
 */
public class ExpSubRoutine extends AbstractSubRoutine {

    /**
     * Creates a new ExpSubRoutine.
     */
    public ExpSubRoutine() {
        super(false, param("x"));
    }
    ...
    public FunctionAssignment evaluateSubroutine(final FunctionProvider functionProvider, final Map<String, FunctionAssignment> arguments) {
        ...
        return new NumberSourceAssignment(Math.exp(number.doubleValue()));
    }
}
