 ...
 */
public class SinSubRoutine extends AbstractSubRoutine {

    /**
     * Creates a new SinSubRoutine.
     */
    public SinSubRoutine() {
        super(false, param("x"));
    }
    ...
    public FunctionAssignment evaluateSubroutine(final FunctionProvider functionProvider, final Map<String, FunctionAssignment> arguments) {
        ...
        return new NumberSourceAssignment(Math.sin(number.doubleValue()));
    }
}
